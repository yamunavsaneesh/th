          ...
          <div class="col-md-3 col-sm-12 col-xs-12">
            <div>
              ...
              <ul class="list-unstyled top_profiles scroll-view">
                ...
                <li class="media event"> <a class="pull-left border-green profile_thumb"> <i class="fa fa-user green"></i> </a>
                  <div class="media-body"> <a class="title" href="#">Ms. Mary Jane</a>
                    <p><strong>$2300. </strong> Agent Avarage Sales </p>
                    <p> <small>12 Sales Today</small> </p>
                  </div>
                </li>
                <li class="media event"> <a class="pull-left border-blue profile_thumb"> <i class="fa fa-user blue"></i> </a>
                  <div class="media-body"> <a class="title" href="#">Ms. Mary Jane</a>
                    <p><strong>$2300. </strong> Agent Avarage Sales </p>
                    <p> <small>12 Sales Today</small> </p>
                  </div>
      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          <article class="media event"> <a class="pull-left date">
            ...
            <div class="media-body"> <a class="title" href="#">Item One Tittle</a>
          ...
          <article class="media event"> <a class="pull-left date">
            ...
            <div class="media-body"> <a class="title" href="#">Item Two Tittle</a>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
          </article>
          <article class="media event"> <a class="pull-left date">
          ...
          <article class="media event"> <a class="pull-left date">
            ...
            <div class="media-body"> <a class="title" href="#">Item Three Tittle</a>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
          </article>
        </div>
