  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="app-heading">
        <div class="app-title">
          <p class="mt30">&nbsp;</p>
          <div class="title"><span class="highlight">All Users</span></div>
        </div>
      </div>
      <div class="card-body no-padding"><?php echo form_open('admin/users/actions'); ?>
        <div class="content">
          <div class="card-header card-title action-wrap">
            <?php if($this->session->userdata('admin_role')!='1'){  ?>
            <a href="<?php echo site_url('admin/users/add/'); ?>" class="btn btn-info btn-sm" title="Add New"><i class="fa fa-plus"></i></a>
            <?php }?>
            ...
            <table class="table card-table">
              <thead>
                <tr class="headings">
                  ...
                  <?php /*?><th width="15%">T-Shirt size</th><?php */?>
                  <th>Group</th>
              ...
              <tbody>
                ...
                <tr class="even pointer">
                  ...
                  <?php /*?><td col="row" align="left"><?php echo $hunt['shirtsize'];?></td><?php */?>
                  <td col="row" align="left"><?php echo $groups[$hunt['group_id']];?></td>
                  <td col="row" align="left"><?php // echo $hunt['email'];?></td>
                  <td class="a-right a-right" title="<?php echo $activearr[$hunt['status']] ?>"><span class="btn btn-<?php echo $statusarray['class'.$hunt['status']];  ?> btn-xs"><i class="fa <?php echo $statusarray['fa-'.$hunt['status']]; ?>"></i></span></td>
                  <td class="last" nowrap="nowrap"><a class="btn btn-default btn-xs" href="<?php echo site_url('admin/users/view/'.$hunt['id'].'/'.$return) ?>" title="View"><i class="fa fa-file-o"></i> </a>
                    <?php if($this->session->userdata('admin_role')!='1'){  ?>
                    <a class="btn btn-info btn-xs" href="<?php echo site_url('admin/users/edit/'.$hunt['id'].'/'.$return) ?>"><i class="fa fa-pencil"></i></a>
                    <?php } ?>
                    <a class="btn btn-danger btn-xs" href="<?php echo site_url('admin/users/delete/'.$hunt['id'].'/'.$return) ?>" onclick="return confirmBox();"><i class="fa fa-trash-o"></i></a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
