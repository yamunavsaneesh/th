  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
      <div class="app-heading">
        <div class="app-title">
          <p class="mt30">&nbsp;</p>
          <div class="title"><span class="highlight">All Groups</span></div>
        </div>
      </div>
      <div class="card-body no-padding"><?php echo form_open('admin/groups/actions'); ?>
        <div class="content">
          <div class="card-header card-title action-wrap">
            <?php if($this->session->userdata('admin_role')!='1'){  ?>
            <a href="<?php echo site_url('admin/groups/add/'); ?>" class="btn btn-info btn-sm" title="Add New"><i class="fa fa-plus"></i></a>
            <?php } ?>
            ...
            <table class="table card-table">
              ...
              <tbody>
                ...
                <tr class="even pointer">
                  ...
                  <td col="row" align="left"><?php echo $hunt['name'];?></td>
                  <td col="row" align="left"><?php if ($hunt['users']>0) {?>
                    <a href="#" title="Users" data-users="<?php echo site_url('admin/groups/users/'.$hunt['id']) ?>"><?php echo $hunt['users'];?></a>
                    <?php } else {?>
                    0
                    <?php }?></td>
                  ...
                  <td class="last" nowrap="nowrap"><a class="btn btn-default btn-xs" href="<?php echo site_url('admin/groups/view/'.$hunt['id'].'/'.$return) ?>" title="View"><i class="fa fa-file-o"></i> </a>
                    <?php if($this->session->userdata('admin_role')!='1'){  ?>
                    <a class="btn btn-info btn-xs" href="<?php echo site_url('admin/groups/edit/'.$hunt['id'].'/'.$return) ?>"><i class="fa fa-pencil"></i></a>
                    <?php } ?>
                    <a class="btn btn-danger btn-xs" href="<?php echo site_url('admin/groups/delete/'.$hunt['id'].'/'.$return) ?>" onclick="return confirmBox();"><i class="fa fa-trash-o"></i></a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>
